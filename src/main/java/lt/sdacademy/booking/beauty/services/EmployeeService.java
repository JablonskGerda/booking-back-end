...
public class EmployeeService {
    ...
    public List<EmployeePriceDTO> getEmployeesPrice(String title) {
        return employeeConverter.employeePriceListConvert(employeeRepository.findAllByServiceEntityListTitle(title));
    }
    ...
    public EmployeeEntity getOneByNameSurname(String name, String surname) {return  employeeRepository.findFirstByPersonNameAndPersonSurname(name, surname);}
}
